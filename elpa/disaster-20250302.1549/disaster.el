...
;; Created: 2013-03-02
;; Package-Version: 20250302.1549
;; Package-Revision: 5b7f7b06ecff
...
(defun disaster-create-compile-command (use-compile-db make-root cwd rel-obj obj-file proj-root rel-file file)
  ...
  (let* ((file (or file (buffer-file-name)))
    ...
    (if (or (string-match-p disaster-c-regexp filename)
        ...
        (let* ((cwd (file-name-directory file)) ;; path to current source file
               ...
               (make-root (disaster-find-build-root use-compile-db proj-root)) ;; path to build root
               (default-directory (if use-compile-db proj-root default-directory))
               ...
               (cc (disaster-create-compile-command use-compile-db make-root cwd rel-obj obj-file proj-root rel-file file))
...
(defun disaster-find-build-root (use-compile-db project-root)
