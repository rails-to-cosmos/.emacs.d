...
(yas-define-snippets 'antlr-mode
                     '(("target" "<target name=\"${1:compile}\" ${2:other}>\n        $0\n</target>" "target" nil nil nil "/Users/akatovda/.emacs.d/snippets/antlr-mode/target" nil nil)
                       ("prop" "<property name=\"${1:name}\" value=\"${2:value}\" />\n$0" "property" nil nil nil "/Users/akatovda/.emacs.d/snippets/antlr-mode/property" nil nil)
                       ("proj" "<project name=\"${1:test}\" default=\"${2:compile}\" basedir=\"${3:.}\">\n\n$0\n</project>" "project" nil nil nil "/Users/akatovda/.emacs.d/snippets/antlr-mode/project" nil nil)))
