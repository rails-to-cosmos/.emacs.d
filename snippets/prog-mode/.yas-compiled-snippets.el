...
(yas-define-snippets 'prog-mode
                     '(("x" "`(yas-with-comment \"XXX: \")`" "xxx" nil nil nil "/Volumes/Main/Users/akatovda/.emacs.d/snippets/prog-mode/xxx" nil nil)
                       ("t" "`(yas-with-comment \"TODO: \")`" "todo" nil nil nil "/Volumes/Main/Users/akatovda/.emacs.d/snippets/prog-mode/todo" nil nil)
                       ("fi" "`(yas-with-comment \"FIXME: \")`" "fixme"
                        (not
                         (eq major-mode 'sh-mode))
                        nil nil "/Volumes/Main/Users/akatovda/.emacs.d/snippets/prog-mode/fixme" nil nil)
                       ("col" "${1:$(yas-trimmed-comment-start)} ${1:comment} ${1:$(let* ((str \"\")\n                                               (curr (current-column))\n                                               (start (yas-trimmed-comment-start))\n                                               (lastcom (substring start -1))\n                                               (end (yas-trimmed-comment-end)))\n                                             (while (< (length str) (- 79 (+ curr (length end))))\n                                                    (setq str (concat str lastcom)))\n                                           (concat str end))}$0" "commentline" nil nil nil "/Volumes/Main/Users/akatovda/.emacs.d/snippets/prog-mode/commentline" nil nil)
                       ("cob" "${1:$(let* ((col (current-column))\n           (str \"\")\n           (lastcom (substring (yas-trimmed-comment-start) -1))\n           (start (yas-trimmed-comment-start))\n           (end (yas-trimmed-comment-end))\n           (over (- (+ (string-width yas-text) (length start) (length end) col) 77)))\n         (while (< (length str) (+ (- 79 (length start) (length end) col) (if (> over 0) over 0)))\n                (setq str (concat str lastcom)))\n       (concat start str end))}\n${1:$(let* ((col (current-column))\n           (str \"\")\n           (start (yas-trimmed-comment-start))\n           (end (yas-trimmed-comment-end)))\n         (while (< (length str) (ffloor (/ (- 78.0 (+ col (length start) (string-width yas-text) (length end))) 2.0)))\n                (setq str (concat str \" \")))\n        (concat start str))} ${1:comment} ${1:$(let* ((col (current-column))\n                                                     (str \"\")\n                                                     (start (yas-trimmed-comment-start))\n                                                     (end (yas-trimmed-comment-end)))\n                                                   (while (< (length str) (- 79.0 (if (eq (mod (string-width yas-text) 2) 1) (- col 1) col) (length end)))\n                                                          (setq str (concat str \" \")))\n                                                 (concat str end))}\n${1:$(let* ((col (current-column))\n           (str \"\")\n           (lastcom (substring (yas-trimmed-comment-start) -1))\n           (start (yas-trimmed-comment-start))\n           (end (yas-trimmed-comment-end))\n           (over (- (+ (string-width yas-text) (length start) (length end) col) 77)))\n         (while (< (length str) (+ (- 79 (length start) (length end) col) (if (> over 0) over 0)))\n                (setq str (concat str lastcom)))\n       (concat start str end))}$0" "commentblock" nil nil nil "/Volumes/Main/Users/akatovda/.emacs.d/snippets/prog-mode/commentblock" nil nil)
                       ("co" "${1:$(yas-trimmed-comment-start)} ${1:comment}${1:$(unless (eq (length comment-end) 0) (concat \" \" (yas-trimmed-comment-end)))}$0" "comment" nil nil nil "/Volumes/Main/Users/akatovda/.emacs.d/snippets/prog-mode/comment" nil nil)))
