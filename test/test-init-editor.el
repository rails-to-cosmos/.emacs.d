;;; test-init-editor.el --- Tests for init-editor functions -*- lexical-binding: t; -*-
...
(defvar test--editor-file
  (expand-file-name "../src/init-editor.el"
...
(provide 'test-init-editor)
;;; test-init-editor.el ends here
