...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:foreground "#030303" :background "#bdbdbd" :height 0.9
                              :box (:line-width 4 :color "#bdbdbd")))))

 '(mode-line-inactive ((t (:foreground "#bdbdbd" :background "#2b2b2b" :height 0.9
                              :box (:line-width 4 :color "#2b2b2b")))))
